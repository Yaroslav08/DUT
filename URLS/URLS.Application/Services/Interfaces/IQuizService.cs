...
namespace URLS.Application.Services.Interfaces
{
    ...
    {
        Task<Result<List<QuizViewModel>>> GetQuizzesBySubjectIdAsync(int subjectId, int offset = 0, int count = 10);
        Task<Result<QuizViewModel>> GetQuizByIdAsync(Guid id, bool withQuestions = false);
