...
namespace URLS.Application.Seeder
{
    public class LocalSeederService : ISeederService
    {
        ...
        public LocalSeederService(URLSDbContext db)
        {
            _db = db;
        }
        ...
        public async Task SeedSystemAsync()
        {
            ...
            if (!await _db.Apps.AnyAsync())
            {
                ...
                var app4 = new App
                {
                    Name = "URLS Desktop Application",
                    ShortName = "URLS Desktop",
